...
/**
 * 7、带callback的消息发送
 * 增加回调处理，这里不再使用application.properties默认配置的方式，
 * 会在程序中显示的使用文件中的配置信息。该示例中没有新建队列和exchange，
 * 用的是第5节中的topic.messages队列和exchange转发器。消费者也是第5节中
